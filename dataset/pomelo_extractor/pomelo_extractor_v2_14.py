...
class PomeloExtractor:
    ...
    def __init__(self, model_type="vit_h", checkpoint_path="dataset/pomelo_extractor/sam_vit_h_4b8939.pth"):
...
def main():
    ...
    parser.add_argument('--input', '-i', default=r"dataset\pomelo_images\raw", required=True)
    parser.add_argument('--output', '-o', default=r"dataset\pomelo_images\extracted", required=True)
    parser.add_argument('--max', '-m', type=int, default=None)
    parser.add_argument('--csv', default=r"dataset\tracker\tracker.csv")
